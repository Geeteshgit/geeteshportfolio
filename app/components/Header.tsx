...
const Header = () => {
  ...
  return (
    <header className="h-[100px] w-full mx-auto sticky z-[999] top-0 left-0 flex flex-col items-center">
      <button
        className="sm:hidden w-full flex justify-between items-center gap-2 rounded-lg bg-purple-900/10 backdrop-blur-md border border-purple-700 mt-6 px-5 py-1"
        onClick={() => setIsOpen(!isOpen)}
      > 
        <span className="text-2xl text-transparent bg-clip-text bg-gradient-to-r from-purple-300 via-purple-100 to-purple-300">Geetesh Dalal</span>
        {isOpen ? <RxCross2 className="text-5xl" /> : <TbMenu3 className="text-5xl" />}
      </button>
